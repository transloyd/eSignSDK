...
use Transloyd\Services\ESign\ESign;
use Transloyd\Services\ESign\Provider;
use Transloyd\Services\ESign\ESignManager;
...
class ESignManagerTest extends TestCase
{
    ...
    public function testCreateSession(): void
    {
        ...
        $this->assertNotEmpty($em->getSignedDocumentRaw($base64, $keyData));
    }
}